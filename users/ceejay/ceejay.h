...
enum custom_user_layers {
    _WIN,   // Windows layout
    _MAC1,  // macOS layout 1 (CTRL OPTION CMD)
    _MAC2,  // macOS layout 2 (CMD  CTRL   OPTION)
    _MAC3,  // macOS layout 3 (CMD  OPTION CTRL)
    _FNWIN, // FN layer for Windows layout
    _FNMAC, // FN layer for both macOS layouts
    _CONFIG // Configuration layout
};
